...
<?php if (!$drank): ?>
    <!-- Product bestaat niet of ID ontbreekt -->
...
<?php else: ?>
    <div class="detail-pagina">
        ...
        <!-- Productafbeelding, valt terug op placeholder als afbeelding ontbreekt -->
        ...
        <div class="detail-info">
            ...
            <div class="detail-knoppen">
                <!-- Na toevoegen keert de gebruiker terug naar deze detailpagina -->
